...
async def h_demo_video(request):
    v_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "demo_foreground_service.mp4")
...
def make_app():
    ...
    app.router.add_get("/demo",             h_demo_page)
    app.router.add_get("/demo.html",        h_demo_page)
    app.router.add_get("/demo.mp4",         h_demo_video)
    app.router.add_get("/video",            h_demo_page)
